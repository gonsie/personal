...
%\item 2016-Present, Associate Editor for {\em IEEE Transactions on Parallel and Distributed Systems}.
\end{itemize}
...
\begin{tabular}{ll}
{\em Insert Text Here}
% 2009 & {\em\bf Best Paper}: $23^{rd}$ Workshop on Parallel and Distributed Simulation (PADS 2009)\\
\end{tabular}
\vskip 6pt
